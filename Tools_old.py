...
test0 = True # distance(A, B)
test1 = True # class Matrix
...
if test0:
    ...
    pairs_of_points = [
        ...
        (range(9), range(9)),
        ((5, 3), (7, 1, 4))]
    for (A, B) in pairs_of_points:
        print "distance({0}, {1}) = {2}".format(A, B, distance(A, B))
        print "A + B =", Binary_operators_dictionary['vector +'](A, B)
