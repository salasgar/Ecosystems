...
void test_2() {
  ...
  ecosystem.create_new_organisms(PLANT_A, 0);
  ecosystem.create_new_organisms(PLANT_B, 1);
  ecosystem.create_new_organisms(HERBIVORE, 0);
  ecosystem.create_new_organisms(CARNIVORE, 0);
